...
def main():
    ...
    parser.add_argument("--video_root_dir", type=str, help="video root dir", default="./datasets/MSRVTT/raw_videos/")
    parser.add_argument("--save_dir", type=str, help="save frame dir ", default="./datasets/MSRVTT/")
    ...
    parser.add_argument("--video_info_tsv", type=str, default="./datasets/MSRVTT/train.img.tsv",
