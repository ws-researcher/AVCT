...
data_vid_id = "datasets/MSRVTT/raw_videos/{}.mp4"

# dataset_path: path to dataset
dataset_path = "./datasets/MSRVTT/"
...
visual_file = "./datasets/MSRVTT/{}.img.tsv"
# {}.caption.tsv: we use it to store  captions
cap_file = "./datasets/MSRVTT/{}.caption.tsv"
...
linelist_file = "./datasets/MSRVTT/{}.linelist.tsv"
...
label_file = "./datasets/MSRVTT/{}.label.tsv"
...
def process(split_type, csv_path=None):
    # structs we need
    img_label = []
    rows_label = []
    caption_label = []
