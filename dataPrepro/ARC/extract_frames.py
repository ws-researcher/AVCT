...
def main():
    ...
    parser.add_argument("--video_root_dir", type=str, help="video root dir", default="./datasets/ARC/videos/")
    parser.add_argument("--save_dir", type=str, help="save frame dir ", default="./datasets/ARC/0/")
    ...
    parser.add_argument("--video_info_tsv", type=str, default="./datasets/ARC/0/train.img.tsv",
