...
def main():
    ...
    parser.add_argument("--video_root_dir", type=str, help="video root dir", default="./datasets/BDDX/raw_videos/")
    parser.add_argument("--save_dir", type=str, help="save frame dir ", default="./datasets/BDDX/")
    ...
    parser.add_argument("--video_info_tsv", type=str, default="./datasets/BDDX/test.img.tsv",
