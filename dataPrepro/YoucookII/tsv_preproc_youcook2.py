...
Youcook2_anns = './datasets/YouCook2/annotations/youcookii_annotations_trainval.json'
Youcook2_subtitle = './datasets/YouCook2/annotations/yc2_subtitles.jsonl'
        ...
        if subset == database[video_name]['subset']:
            ...
            for i in range(num_ann - 1):
                ...
                # if start_time_unobserved >= end_time_observed:
                    ...
                    output_captions = []
                    # asr_text = asr_dict['{}_{}'.format(video_name, sample_observed_id)]
