...
def main():
    ...
    parser.add_argument("--video_root_dir", type=str, help="video root dir", default="./datasets/YouCook2/videos/")
    parser.add_argument("--save_dir", type=str, help="save frame dir ", default="./datasets/YouCook2/")
    ...
    parser.add_argument("--video_info_tsv", type=str, default="./datasets/YouCook2/train.img.tsv",
